%%%-------------------------------------------------------------------
%%% File    : mod_register_web_plus.erl
%%% Author  : Stefan Strigler <stefan@strigler.de>
%%% Purpose : Web page to register account and related tasks
%%% Created : 4 November 2024 by Stefan Strigler <stefan@strigler.de>
%%%
%%% This is a copy of the original `mod_register_web` written by Badlop
